...
namespace Implementations.Sensors.RoomM370 {
    public class DummyEnergyConsumptionAccumulatorSensor : ISensor {
        private readonly DummyRoomM370 _dummyRoomM370;

        public DummyEnergyConsumptionAccumulatorSensor(string sensorName, string procedureName, DummyRoomM370 dummyRoomM370) {
        ...
        public async Task<object> ObservePropertyValue(params object[] inputProperties) {
            return _dummyRoomM370.EnergyConsumptionAccumulated;
        }
    }
}
