...
namespace Logic.Mapek
{
    public class MapekPlan : IMapekPlan, IDisposable 
    {
        ...
        public IEnumerable<(SimulationPath, double)>? GetOptimalSimulationPathsEuclidian(IEnumerable<SimulationPath> simulationPaths, IEnumerable<OptimalCondition> optimalConditions)
        {            
