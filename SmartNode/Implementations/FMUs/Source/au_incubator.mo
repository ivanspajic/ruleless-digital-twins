model au_incubator
  ...
  parameter Real C_heater; // This has a start value, but I'm not sure where it's from.
  parameter Real G_heater; // This has a start value, but I'm not sure where it's from.
