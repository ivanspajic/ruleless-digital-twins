...
namespace Logic.Mapek
{
    public class MapekManager : IMapekManager
    {
        ...
        // The number of MAPE-K cycles simulated ahead. Should this be a part of the instance model? It's meta-information.
        ...
        private void RunMapekLoop(string instanceModelFilePath, string fmuDirectory, string dataDirectory, int maxRound = -1, bool simulateTwinningTarget = false)
        {
            ...
            while (_isLoopActive)
            {
                ...
                var mitigationActions = _mapekAnalyze.Analyze(instanceModel, propertyCache);
                ...
                var optimalSimulationConfiguration = _mapekPlan.Plan(mitigationActions,
                    propertyCache,
                    instanceModel,
                    fmuDirectory,
                    LookAheadCycles);
